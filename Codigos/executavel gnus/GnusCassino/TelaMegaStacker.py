...
class TelaMegaStacker:
    ...
    def __init__(self,user,janela):
        ...
        self.fundo = pygame.image.load('imagem/megaStacker.png')
        self.btnPare = pygame.image.load('imagem/spacebtn.png')
        self.btnReinicia = pygame.image.load('imagem/restart2.png')
        self.imgWin = pygame.image.load('imagem/ganhou2.png')
        self.carteira = pygame.image.load('imagem/carteira2.png')
        self.saldoCarteira = pygame.image.load("imagem/qtdcarteira.png")
        self.soma = pygame.image.load('imagem/SOMA.png')
        self.aposta = pygame.image.load('imagem/aposta3.png')
        self.cinco = pygame.image.load('imagem/cinco.png')
        self.dez = pygame.image.load('imagem/dez.png')
        self.vinteCinco = pygame.image.load('imagem/vintecinco.png')
        self.cinquenta = pygame.image.load('imagem/cinquenta.png')
        self.cem = pygame.image.load('imagem/cem.png')
        self.perdeuimagem = pygame.image.load('imagem/perdeu1.png')
        self.btnOk = pygame.image.load('imagem/btnOk.png')
        self.headrank = pygame.image.load('imagem/quadroRanking.png')
        self.btnRetornar = pygame.image.load('imagem/voltar2.png')
        ...
        self.desapostar = pygame.image.load('imagem/btnApagar.png')
